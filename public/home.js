      ...
      case "home":
        content = `
          <div class="placeholder-content">
            ...
            <p>Aoowit support is the customer care service for Aoowit an online platform for buying dick enlargement cream and for good performance in bed.

The Aoowit Support team is responsible for:

1. Answering questions about Aoowit services and features.
2. Ordering Aoowit and Testing out on an escort a week later.
3. Resolving issues with delivery, transaction and payment.
4. Providing guidance on security verification and compliance.

You can typically contact Aoowit Support through here
.</p>
          </div>
        `
        break
